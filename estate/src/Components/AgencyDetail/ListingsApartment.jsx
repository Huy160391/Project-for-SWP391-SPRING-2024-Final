        ...
        {listings.length > 0 ? (
          listings.map((listing) => (
            <div key={listing.agencyId} className="bg-white p-4 rounded-lg shadow-lg">
              ...
              />
              <div className="mt-4">
                <h3 className="font-bold text-xl mb-2">{listing.name || `Apartment: ${typeof listing.apartmentId === 'string' && listing.apartmentId.includes(":") ? listing.apartmentId.split(":").pop() : listing.apartmentId}`}</h3>
