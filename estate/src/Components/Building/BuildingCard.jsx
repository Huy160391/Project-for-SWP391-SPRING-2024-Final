...
const BuildingCard = ({ buildingId, name, describe, images, status }) => {
  ...
  return (
    <div className="property-card p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-blue-500" onClick={navigateToPropertyDetails} tabIndex="0" role="button" onKeyPress={(e) => {
