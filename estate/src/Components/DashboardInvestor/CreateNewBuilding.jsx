...
const CreateNewBuilding = () => {
      ...
      if (selectedProject) {
        ...
        if (match) {
          ...
          if (!newValue.startsWith(selectedProjectPrefixWithDash)) {
            newValue =
              selectedProjectPrefixWithDash +
              value.replace(selectedProjectPrefixWithDash, "");
          }
          setProjectDetails((prevDetails) => ({
            ...prevDetails,
            [name]: newValue,
  ...
  const handleSubmit = async (event) => {
    ...
    const isBuildingNameExists = buildings.some(
      (building) => building.name === projectDetails.name
    );
    ...
    if (
      ...
      alert(
        `Number of floors must be at least 5, and number of apartments must be at least ${minimumApartments} (10 per floor) and divisible by the number of floors.`
      );
      return;
    }
    ...
    try {
      await axios.post(
        "https://localhost:7137/api/Buildings/PostInfomationAndImage",
        formData,
        {
          headers: {
  ...
  return (
    <div className="container mx-auto mt-10 font-serif">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              onChange={handleInputChange}
              value={projectDetails.numberOfFloor}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              onChange={handleInputChange}
              value={projectDetails.numberOfApartment}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            />
          </div>
        ...
        <button
          onClick={handleBack}
          className="mb-4 bg-gray-200 text-gray-800 hover:bg-gray-300 px-4 py-2 rounded-md"
        >
          Back
        </button>
      </div>
