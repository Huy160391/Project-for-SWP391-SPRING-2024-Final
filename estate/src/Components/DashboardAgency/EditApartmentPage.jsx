...
// =======
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(
        `https://localhost:7137/api/Apartments/UploadInformationWithImage/${apartmentId}`,
        formData,
        {
      ...
      navigateAndReload(
        `/ManagerListApartmentOfAgency/${apartment.agencyId}/${apartment.buildingId}`
      );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="form-group">
            ...
            {image && (
              <img
                ...
                className="mt-4 w-auto h-48 rounded-lg"
              />
            )}
          </div>
          <div className="form-group">
            ...
            {/* Validation for number of characters in description*/}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.numberOfBedrooms && (
              <p className="text-red-500">{errors.numberOfBedrooms}</p>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.numberOfBathrooms && (
              <p className="text-red-500">{errors.numberOfBathrooms}</p>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.furniture && (
              <p className="text-red-500">{errors.furniture}</p>
            )}
          </div>
